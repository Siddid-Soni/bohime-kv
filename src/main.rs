...
#[derive(Subcommand)]
enum Cmd {
    /// Run a node. Every node takes the same --node list, --shards and --rf.
    Serve {
        #[arg(long)]
        id: u64,
